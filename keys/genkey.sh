...
cp jenkins-master-key ../jenkins-data/JENKINS_HOME/.ssh/id_rsa
cp jenkins-master-key.pub ../jenkins-data/JENKINS_HOME/.ssh/id_rsa.pub
...
chmod 700 ../jenkins-data/JENKINS_HOME/.ssh
